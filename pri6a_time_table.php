...
.label{
  ...
  <div class="container">
      <center><h3 class='text-default'>Select Subject and Create Time Table for Primary 6A</h3></center></br>
	<form role="form" action="pri6a_time_table_handller.php" method="post">
	   <div class="row">
