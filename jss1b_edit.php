...
$id=$_GET["id"];
$select="SELECT *FROM jss1b_schoolfee WHERE register_id='$id'";
...
if(mysqli_num_rows($query)>=1){
    ...
    ?>
<div class="form" style=" margin-bottom: 10%"><br><br><br>
    <h4>Enter Amount To Update School Fee</h4>
     <form method="POST" action="jss1b_update.php?id=<?php echo "$user" ?>" >
