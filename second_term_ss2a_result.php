 <?php
           include_once("connection.php");
              $id=$_GET["id"];
              $select="SELECT  *FROM ss2a_register WHERE admission_no='$id'";
            ...
            $select="SELECT *FROM second_term_ss2a WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
                 ...
                 $Average=$row["Average"];
                 $form_master_remark=$row["Form_Teacher_Remark"];
                 $house_master_remark=$row["Form_Teacher_Name"];
        ...
        <a href="first_term_ss1a_login.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
          ...
          <div class="container" style=" padding-left: 15%; padding-right: 8%; padding-top: 5%;" id="b">
             <table cellpadding="15px" width="100%" cellspacing="0px" style="width:100%;">
               ...
               <?php
               $query="SELECT *FROM ss2a_register WHERE admission_no='$id'";
    ...
    $(document).ready(function(){
     ...
     <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:2em;">
        <thead>
            ...
            <th style="width:15%">Age: <?php echo  '16+';?></th>
            <th style="width:25%">Class:  <?php echo  'S.S.S 2A';?></th>
            </tr>
    </thead>
            </table>
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:2em;">
            ...
            <th style="width:25%;">Term:  <?php echo  'Second Term';?></th>
            ...
            <tr>
            <th></th>
            <th style=" padding-left: 10px;" id="cd">1st<br> CA</th>
            ...
            <tr>
                <td style="line-height:1.5em; padding-left: 15px;">Agricultural Science</td>
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="margin-bottom:1%;" >
             <tbody>
               <tr>
                    ...
                    <td style="line-height: 1.5em; font-size: 14px; padding-left: 5px; width: 69%;"><?php echo $form_master_remark;?></td>
                </tr>
                 <tr>
                    <td style="line-height: 1.5em; font-size: 14px; padding-left: 5px; width: 31%;">Class Teacher's Name:</td>
                    <td style="line-height: 1.5em; font-size: 14px; padding-left: 5px; width: 69%;"><?php echo $house_master_remark;?></td>
                </tr>
                 <tr>
                    <td style="line-height: 1.5em; font-size: 14px; padding-left: 5px; width: 31%;">This Term ends</td>
                    <td style="line-height: 1.5em; font-size: 14px; padding-left: 5px; width: 69%;">8 APRIL, 2022</td>
                </tr>
                 <tr>
                    <td style="line-height: 1.5em; font-size: 14px; padding-left: 5px; width: 31%;">Next Term Begins</td>
                    <td style="line-height: 1.5em; font-size: 14px; padding-left: 5px; width: 69%;">25TH APRIL, 2022</td>
                </tr>
             </tbody>
             </table>
                </div>
