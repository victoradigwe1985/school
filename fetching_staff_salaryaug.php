...
<div class="container" style="margin-top: -15%;" style="">
    <table  class=" table table-condensed  table-striped table-bordered" style="width:1490px" id="table2"><thead><tr><th style="padding-left: 28%;">Consolidated Salary Sheet For The Month of August</th></tr></thead></table>
 ...
 $select="SELECT * FROM staff_salaryaug";
 ...
 while($fetch=mysqli_fetch_array($query)){
	 ...
	 $staff_id=$fetch["staff_id"];
	    ...
	    $netpay=$fetch["net_pay"];
             $edit ='<a href="staff_salary_editaug.php?id='.$fetch['register_id'].'"><button  type="button " value="Edit">Add</button></a>';
        ...
        <td>$staff_id</td>
		   ...
		   <td>$BON</td>
                   ...
                   <td>$DA</td>
                    ...
                    <td>$total2</td>
                    <td>$netpay</td>
		   <td><form method='post' action='salary_deleteaug.php'>
...
?>
    <p style="margin-right:-119%; font-size:16px;"  > <b>TOTAL: ₦ </b></p> <p style="margin-left:113.5%;  border:2px solid lavender; width: 6%; margin-top: -4.5%; font-size: 16px; padding-top: 1.5%;"><b> <?php   echo"$netpay1"; ?></b></p>;   
        ...
        <div class="container"> <a href="fetching_staff_salaryaug1.php"><button value="OK">Extract To Print</button></a></div>
 </div> 
    </div>
    </body>
</html>