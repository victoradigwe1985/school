...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <div class="dropdown-content">
      <a href="jss1a_fetchingdata.php">J.S.S 1A</a>
      <a href="jss1b_fetchingdata.php">J.S.S 1B</a>
      <a href="jss1c_fetchingdata.php">J.S.S 1C</a>
  </div>
   </div>   
<div class="dropdown">
  <button class="dropbtn">J.S.S 2</button>
  <div class="dropdown-content">
     <a href="jss2a_fetchingdata.php">J.S.S 2A</a>
     <a href="jss2b_fetchingdata.php">J.S.S 2B</a>
     <a href="jss2c_fetchingdata.php">J.S.S 2C</a>
  </div>
</div> 
  <div class="dropdown">
  <button class="dropbtn">J.S.S 3</button>
  <div class="dropdown-content">
      <a href="jss3a_fetchingdata.php">J.S.S 3A</a>
      <a href="jss3b_fetchingdata.php">J.S.S 3B</a>
     <a href="jss3c_fetchingdata.php">J.S.S 3C</a>
  </div>
  </div>
  <div class="dropdown">
  <button class="dropbtn">S.S.S 1</button>
  <div class="dropdown-content">
     <a href="ss1a_fetchingdata.php">S.S.S 1A</a>
     <a href="ss1b_fetchingdata.php">S.S.S 1B</a>
     <a href="ss1c_fetchingdata.php">S.S.S 1C</a>
  </div>
</div> 
  <div class="dropdown">
  <button class="dropbtn">S.S.S 2</button>
  <div class="dropdown-content">
      <a href="ss2a_fetchingdata.php">S.S.S 2A</a>
      <a href="ss2b_fetchingdata.php">S.S.S 2B</a>
  </div>
</div>
<div class="dropdown">
  <button class="dropbtn">S.S.S 3</button>
  <div class="dropdown-content">
      <a href="ss3a_fetchingdata.php">S.S.S 3A</a>
      <a href="ss3b_fetchingdata.php">S.S.S 3B</a>
