 <?php
           include_once("connection.php");
            ...
            $select="SELECT *FROM first_term_ss2a WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
...
<html>
    ...
    <body>
        ...
        <a href="first_term_ss2a_login.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
