...
#scroll {
  ...
  padding: 5px;
    ...
    <body>
        ...
        <a href="pri1a_select_term_assessment.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
    ...
    <table class="table  table-bordered table-condensed  table-striped">
            ...
            $query=mysqli_query($connect,$select);
                ...
                $edit ='<a href="pri1b_assessment_third_edit_1.php?id='.$row['register_id'].'"><button  type="button " value="Edit">Add</button></a>';
