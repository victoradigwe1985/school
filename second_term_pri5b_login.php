...
<html>
    ...
    <body>
        ...
        <a href="pri5b_select_term.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
  ...
  <form class="form-horizontal" role="form" action="second_term_pri5b_login_handler.php" method="POST" >
