 <?php
           include_once("connection.php");
              $id=$_GET["id"];
              $select="SELECT  *FROM pri6a_register WHERE admission_no='$id'";
            ...
            $select="SELECT *FROM primary6a_first_term_scores WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
                 ...
                 $Average=$row["Average"];
                  ...
                  $select="SELECT *FROM pri6a_assessment_register WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
    ...
    <body>
        ...
        <div class="container" style=" padding-left: 15%; padding-right: 8%; padding-top: 10%;" id="b">
             <table cellpadding="15px" width="100%" cellspacing="0px" style="width:100%;">
               ...
               <?php
               $query="SELECT *FROM pri6a_register WHERE admission_no='$id'";
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 14px; line-height:1.5em;">
                <thead>
            <tr>
            <th style="">Total Mark Obtainable: 1700</th>
    ...
    <thead>
          ...
          <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="" >
           ...
           <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="">
            ...
            <td style="text-align: center;"><?php echo $fr_total;?></td>
            <td style="text-align: center;"><?php echo $fr_gl;?></td>
            <td style="text-align: center;"><?php echo $fr_sg;?></td>
            </tr>
           </table> 
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="">
    <thead>
