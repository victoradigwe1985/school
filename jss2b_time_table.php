...
.label{
    ...
    <body>
        ...
        <a href="class_selector_create_timetable.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
         ...
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; margin-left:14%;" id=""> 
         
          
  <div class="container">
      <center><h3 class='text-default'>Select Subject and Create Time Table for J.S.S 2B</h3></center></br>
	<form role="form" action="jss2b_time_table_handller.php" method="post">
	  <div class="row">
