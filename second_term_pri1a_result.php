 <?php
           include_once("connection.php");
            ...
            $select="SELECT *FROM primary1a_second_term_scores WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
                 ...
                 $Average=$row["Average"];
                  ...
                  $select="SELECT *FROM pri1a_assessment_second_register WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 14px; line-height:1.9em;">
           ...
           <th style="width:31%;">Term Ends:  <?php echo  '7th April 2022';?></th>
