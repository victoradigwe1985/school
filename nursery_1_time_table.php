...
.label{
  ...
  <div class="container">
      <center> <h3 class='text-default'>Select Subject and Create Time Table for Nursery 1</h3></center></br>
	<form role="form" action="nursery_1_time_table_handller.php" method="post">
	   <div class="row">
