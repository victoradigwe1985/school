...
.label{
  ...
  <div class="container">
      <center><h3 class='text-default'>Select Subject and Create Time Table for J.S.S 1B</h3></center></br>
	<form role="form" action="jss1b_time_table_handller.php" method="post">
	  <div class="row">
