...
#table{
    ...
    <center style="margin-bottom: -10%;"> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOL</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h5><h5><strong> NURSERY/PRIMARY AND SECONDARY SCHOOL,</strong></h5></center><br><br><br><br>
    
 
 
    <table  class="table table-condensed  table-striped table-bordered" style="width:100%;" id="table2"><thead><tr><th style="padding-left: 28%;">Consolidated Salary Sheet For The Month Of April </th></tr></thead></table>
