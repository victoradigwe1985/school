...
#scroll {
  ...
  padding: 5px;
    ...
    <body>
     ...
     <center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOLS</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h5><h5><strong> NURSERY/PRIMARY AND SECONDARY SCHOOL,</strong></h5><h6><strong> Nurseery 1 First Term Assessment Records</strong></h6></center>
    <br>
    <table class="table  table-bordered table-condensed  table-striped">
            ...
            $select="SELECT * FROM nursery_1_assessment_first_register";
            $query=mysqli_query($connect,$select);
                ...
                $edit ='<a href="nursery_1_assessment_first_edit_1.php?id='.$row['register_id'].'"><button  type="button " value="Edit">Add</button></a>';
