...
gender{
  ...
  <div class="container" style="width:200px; height:1500px;position: fixed; background-color: black; margin-left: 0px; float: left; padding-top: 20px;" id="con">
        ...
        <a href="homepage.php" class="btn btn-lg btn-success" style="border-color:gray;  font-size: 15px; color:white;  margin-top: 10px;">Goto Main Menu</a><br>
        <a href="class_selector_database.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 15px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
...
$id=$_GET["id"];
$select="SELECT *FROM js2b_register WHERE register_id='$id'";
...
<div class="form" style=" margin-bottom: 10%">
     ...
     <form method="POST" action="jss2b_update_1.php?id=<?php echo "$user" ?>" >
     <h2>Edit and update this record</h2><br><br>
