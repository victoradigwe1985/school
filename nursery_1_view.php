...
$id=$_GET["id"];
$select="SELECT *FROM nursery_1_register WHERE register_id='$id'";
...
#con{
    ...
    <body>
      <div class="container" style="width:200px; height:1500px; background-color: black; margin-left: 0px; float: left; padding-top: 20px;" id="con">
        ...
        <a href="nursery_1_fetchingdata.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
    ...
    <Center>
        <table class="table table-bordered">
               ...
               <?php
               $query="SELECT *FROM nursery_1_register WHERE register_id='$id'";
...
?>
<center style=""><a href="nursery_1_fetchingdata.php"><button value="OK">OK</button></a></center>
