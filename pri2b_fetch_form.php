...
$select="SELECT *FROM pri2b_register WHERE register_id=(SELECT max(register_id) FROM pri2b_register)";
...
if(mysqli_num_rows($query)>0){
    ...
    ?>
        ...
        <a href="pri2b_form.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;">Register New</a><br>
        </div>
