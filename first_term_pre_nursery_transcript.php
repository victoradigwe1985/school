...
#scroll {
  ...
  padding: 20px;
    ...
    <body>
        ...
        <a href="pre_nursery_select_term_transcript.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
    ...
    <center><div class="container" style="margin-top: 5%;"> <a href="first_term_pre_nursery_transcript_1.php"><button value="OK">Extract To Print</button></a></div></center>
