...
#scroll {
  ...
  padding: 20px;
    ...
    <body>
     ...
     <center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOL</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h5><h5><strong> NURSERY,PRIMARY AND SECONDARY SCHOOL,</strong></h5><h6><strong>Primary 4A FIRST TERM TRANSCRIPT</strong></h6></center>
    <br>
       <table class="table-striped" cellpadding="15px" width="100%" border="1px" cellspacing="0px">
        <tr align="left" >
            ...
            $select="SELECT * FROM first_term_pri4a";
    ...
    <center><div class="container" style="margin-top: 5%;"> <a href="first_term_pri4a_transcript_1.php"><button value="OK">Extract To Print</button></a></div></center>
