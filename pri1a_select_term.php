    ...
    <body>
        ...
        <div class="container-fluid" style="background-color: lightgoldenrodyellow;"> 
            ...
            <center style="margin-top:20px;"> 
                ...
                <a style="margin-top:20px;" href="first_term_pri1a_login.php" class="btn btn-lg btn-success">First Term</a>
                <a style="margin-top:20px;" href="second_term_pri1a_login.php" class="btn btn-lg btn-success">Second Term</a>
                <a style="margin-top:20px;" href="third_term_pri1a_login.php" class="btn btn-lg btn-success">Third Term</a>
            </center>
