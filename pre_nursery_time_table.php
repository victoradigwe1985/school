...
.label{
  ...
  <div class="container">
      <center> <h3 class='text-default'>Select Subject and Create Time Table for Pre-Nursery</h3></center></br>
	<form role="form" action="pre_nursery_time_table_handller.php" method="post">
	   <div class="row">
	    
	  <div class="col-md-2">
	  	<label class="label">Lecture Day</label>
	      <div class="form-group">
		    <select name="select1" class="form-control" value="<?=$day;?>" placeholder="" required="required">
	   ...
	   <div class="col-md-2">
	    <div class="form-group">
		 <label class="label">Time:8am-8:45am</label>
	       <select name="select2" class="form-control" value="<?=$time1;?>" placeholder="">
			   <option>Select course</option>
			   <option>Free</option>
                            <option>Break</option>
			   <option>Assembly/Prayer</option>
			   <option>C.R.S</option>
			   <option>Oral Comm.(L$C.S)</option>
			   <option>Recognition (L$C.S)</option>
			   <option>Writting (L$C.S)</option>
			   <option>Counting (M.S)</option>
			   <option>Recognition (M.S)</option>
                           <option>Writting (M.S)</option>
			  <option>Social N.M.I</option> 
			   <option>Fine & Creative Arts</option>
                           <option>Scientific $ R.T</option>
	  ...
	  <div class="col-md-2">
	    <div class="form-group">
		 <label class="label">Time:8:45am-9:30am</label>
		    <select name="select3" class="form-control" value="<?=$time2;?>" placeholder="">
			   <option>Select course</option>
			   <option>Free</option>
                            <option>Break</option>
			   <option>Assembly/Prayer</option>
	 ...
	 <div class="col-md-2">
	    <div class="form-group">
		    ...
		    <select name="select4" class="form-control" value="<?=$time3;?>" placeholder="">
			   <option>Select course</option>
			   <option>Free</option>
                            <option>Break</option>
			   <option>Assembly/Prayer</option>
	  ...
	  <div class="col-md-2">
	    <div class="form-group">
		 <label class="label">Time:10:15am-11:00am</label>
		    <select name="select5" class="form-control" value="<?=$time4;?>" placeholder="">
			   <option>Select course</option>
			   <option>Free</option>
                            <option>Break</option>
			   <option>Assembly/Prayer</option>
	  ...
	  <div class="col-md-2">
	    <div class="form-group">
		   <label class="label">Time:11:00am-11:45am</label>
		    <select name="select6" class="form-control" value="<?=$time5;?>" placeholder="">
			   <option>Select course</option>
			   <option>Free</option>
                            <option>Break</option>
			   <option>Assembly/Prayer</option>
	  ...
	  <div class="col-md-2">
	     <div class="form-group">
		   <label class="label">Time:11:45am-12:45pm</label>
		    <select name="select7" class="form-control" value="<?=$time6;?>" placeholder="">
			   <option>Select course</option>
	 ...
	 <div class="col-md-2">
	    <div class="form-group">
		  <label class="label">Time:12pm-1:25pm</label>
		    <select name="select8" class="form-control" value="<?=$time7;?>" placeholder="">
			   <option>Select course</option>
			   <option>Free</option>
                            <option>Break</option>
			   <option>Assembly/Prayer</option>
	  ...
	  <div class="col-md-2">
	    <div class="form-group">
		   <label class="label">Time:1:25pm-2:10pm</label>
		    <select name="select9" class="form-control" value="<?=$time8;?>" placeholder="">
			   <option>Select course</option>
			   <option>Free</option>
                            <option>Break</option>
			   <option>Assembly/Prayer</option>
	  ...
	  <div class="col-md-2">
	    <div class="form-group">
		   <label class="label">Time:2:30am</label>
		    <select name="select10" class="form-control" value="<?=$time9;?>" placeholder="">
			   <option>Select course</option>
                           <option>clossing</option>
			   <option>Free</option>
                            <option>Break</option>
