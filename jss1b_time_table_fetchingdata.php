      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
              <li><a href="jss1a_time_table_fetchingdata.php">J.S.S.1A</a></li>
              <li class="active"><a href="jss1b_time_table_fetchingdata.php">J.S.S.1B</a></li>
            <li><a href="jss1c_time_table_fetchingdata.php">J.S.S.1C</a></li>
              <li><a href="jss1b_time_table.php">Goto Create Time Table</a></li> 
          </ul>
...
<br><br><br>
<center> <h4><strong>BRAIN TRUST SECONCARY SCHOOL,</strong></h4><h5><strong>J.S.S 1B First Term Time Table</strong></h5></center>
    <br>
 ...
 $select="SELECT * FROM jss1b_time_table";
 ...
 while($fetch=mysqli_fetch_array($query)){
	 ...
	 $time8=$fetch["time8"];
     $time9=$fetch["time9"];
	 $reset='<a class="btn btn-success" style="color:black;" href="jss1b_timetable_reset.php?id='.$fetch['timeTable_id'].'">Reset</a>';
   ...
   echo "<tr>
		   ...
		   <td>$time9</td>
		   <td>$reset</td>
		   <td><form method='post' action='jss1b_timetable_delete.php'>
...
<div class="container"> <a href="jss1b_time_table_fetchingdata1.php"><button value="OK">Extract To Print</button></a></div>
 </div> 
    </div>
    </body>
</html>