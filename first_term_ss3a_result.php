 <?php
           include_once("connection.php");
              $id=$_GET["id"];
              $select="SELECT  *FROM ss3a_register WHERE admission_no='$id'";
            ...
            $select="SELECT *FROM first_term_ss3a WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
...
<html>
    ...
    <body>
        ...
        <a href="first_term_ss3a_login.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
          ...
          <div class="container" style=" padding-left: 15%; padding-right: 8%; padding-top: 5%;" id="b">
             <table cellpadding="15px" width="100%" cellspacing="0px" style="width:100%;">
               ...
               <?php
               $query="SELECT *FROM ss3a_register WHERE admission_no='$id'";
    ...
    $(document).ready(function(){
     ...
     <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:1.9em; margin-top: 5px;">
        <thead>
            ...
            <th style="width:15%">Age: <?php echo  '15+'?></th>
            <th style="width:25%">Class:  <?php echo 'S.S.S 3A';?></th>
            </tr>
    </thead>
            </table>
