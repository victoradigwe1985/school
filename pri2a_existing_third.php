...
#scroll {
  ...
  padding: 20px;
    ...
    <body>
        ...
        <a href="pri2a_select_session_term.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
      
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; margin-left:15%; padding-bottom: 10%;" id="scroll"> 
         
    <center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOL</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h4><h5><strong> NURSERY/PRIMARY AND SECONDARY SCHOOL,</strong></h5><h5><strong>Primary 2A Third Term School Fee Record</strong></h5></center>
    <br>
    <center> <table class="table  table-bordered table-condensed  table-striped" style="width:100%;" >
            ...
            $select="SELECT * FROM pri2a_schoolfee_third";
            $query=mysqli_query($connect,$select);
              ...
              $total1 += $total;
               ...
               $edit ='<a href="pri2a_edit_third.php?id='.$row['register_id'].'"><button  type="button " value="Edit">Add</button></a>';
                echo "<tr><td>$register_id</td>
                         ...
                         <td>$fullpay</td>
                         <td>$total</td>
                              <td>   <form method='POST' action='pri2a_delete_third.php'>
     ...
     <center><div class="container" style="margin-top: 5%;"> <a href="pri2a_existing1_third.php"><button value="OK">Extract To Print</button></a></div></center>
   </div>
