...
#scroll {
  ...
  padding: 5px;
    ...
    <body>
        ...
        <a href="nursery_2_select_term_assessment.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
        
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; margin-left:5%; padding-bottom: 5%;"  id="scroll"> 
        
     <center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOLS</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h5><h5><strong> NURSERY/PRIMARY AND SECONDARY SCHOOL,</strong></h5><h6><strong> Nurseery 2 Third Term Assessment Records</strong></h6></center>
    <br>
    <table class="table  table-bordered table-condensed  table-striped">
            ...
            $select="SELECT * FROM nursery_2_assessment_third_register";
            $query=mysqli_query($connect,$select);
                ...
                $edit ='<a href="nursery_2_assessment_third_edit_1.php?id='.$row['register_id'].'"><button  type="button " value="Edit">Add</button></a>';
