            ...
            if($query=mysqli_query($connect,$select)){
                ...
                if($num > 0){
                    ...
                    header("location:nursery_1_new_second_term.php?msg=$msg");
                        ...
                        $insert="INSERT INTO nursery_1_seond_schoolfee(stud_id,fullname,firstpay,secondpay,fullpay,total)VALUES('$stud_id','$fullname','$firstpay','$secondpay','$fullpay','$total')";
