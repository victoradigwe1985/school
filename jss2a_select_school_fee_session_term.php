...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
    ...
    <body>
     ...
     <center>  <div class="table" style="padding-top:15%; font-size: 5em;">
             ...
             <a href="jss2a_new_first_term.php"> <button type="button" class="btn btn-success ">FirstTerm</button></a>
          <a href="jss2a_new_second_term.php"> <button type="button" class="btn btn-success  ">Second Term</button></a>
          <a href="jss2a_new_third_term.php"> <button type="button" class="btn btn-success  ">Third Term</button></a>
