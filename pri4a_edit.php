    ...
    <head>
       <meta name="viewport" content="user-scalable=no, initial-scale=1, maximum-scale=1, minimum-scale=1, width=device-width">
        ...
        <link rel="stylesheet" href="/bootstrap.min.css">
	    	<link rel="stylesheet"css href="css/bootstrap-datetimepicker.css">
...
$id=$_GET["id"];
$select="SELECT *FROM pri4a_schoolfee WHERE register_id='$id'";
...
<div class="form" style=" margin-bottom: 10%">
    <h4>Enter Amount To Update School Fee</h4>
     <form method="POST" action="pri4a_update.php?id=<?php echo "$user" ?>" 
