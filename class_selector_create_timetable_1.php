        ...
        <a href="creat_view_timetable_1.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
         ...
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; margin-left:5%;"> 
             ...
             <center> <div class="container" style="padding:5px 15px;"><br><br><br>
                     <h3 style="background-color:green; color:white; width: 25%;">Select Class To Create Student Time Table </h3><br><br><br>
   <div class="dropdown">
  <button class="dropbtn">Nursery</button>
 <div class="dropdown-content">
      <a href="pre_nursery_time_table.php">Pre-Nursery</a>
    <a href="nursery_1_time_table.php">Nursery 1</a>
    <a href="nursery_2_time_table.php">Nursery 2</a>
     <a href="nursery_3_time_table.php">Nursery 3</a>
  </div>
   </div> 
  <div class="dropdown">
  <button class="dropbtn">Primary 1</button>
  <div class="dropdown-content">
      <a href="pri1a_time_table.php">Primary 1A</a>
    <a href="#">Primary 1B</a>
    <a href="#">Primary 1C</a>
  </div>
   </div>                   
<div class="dropdown">
  ...
  <div class="dropdown-content">
      <a href="pri2a_time_table.php">Primary 2A</a>
    <a href="#">Primary 2B</a>
    <a href="#">Primary 2C</a>
  </div>
</div> 
  ...
  <div class="dropdown-content">
      <a href="pri3a_time_table.php">Primary 3A</a>
    <a href="#">Primary 3B</a>
    <a href="#">Primary 3C</a>
  </div>
  </div>
  ...
  <div class="dropdown-content">
      <a href="pri4a_time_table.php">Primary 4A</a>
    <a href="#">Primary 4B</a>
    <a href="#">Primary 4C</a>
  </div>
</div> 
  ...
  <div class="dropdown-content">
      <a href="pri5a_time_table.php">Primary 5A</a>
    <a href="#">Primary 5B</a>
  </div>
</div>
<div class="dropdown">
  ...
  <div class="dropdown-content">
      <a href="pri6a_time_table.php">Primary 6A</a>
    <a href="#">Primary 6B</a>
