...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
    ...
    <body>
        ...
        <div class="container-fluid" style="background-color: lightgoldenrodyellow;"> 
            ...
            <center> 
                <div style="float: left; padding: 20px;"><a href="class_selector_result.php" class="btn btn-lg btn-success">Click To View Result</a></div>
                <div style=" padding: 20px;"><a href="class_selector_transcript.php" class="btn btn-lg btn-success">Click To View Transcript</a></div>
            </center>
