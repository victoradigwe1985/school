...
#submit:hover{
  ...
  <div <div style="background-color:lightgray; width: 350px; padding: 5px;"> <a href="jss1c_new_second_term.php"><button value="OK" class="btn btn-gray" id="submit">OK</button></a> <a href="jss1c_second_existing.php"><button value="View Records" class="btn btn-gray" id="submit">View Records</button></a></div>
</div>
