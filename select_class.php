        ...
        <a href="homepage.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
         ...
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; margin-left:10%;"> 
             ...
             <center> <div class="container" style=""><br><br><br>
                 <h4 style="background-color:green; color:white; width: 35%; height: 100px; padding: 10px;">STUDENT REGISTRTION PORTAL</h4><br><br><br>
   <div class="dropdown">
  <button class="dropbtn">J.S.S 1</button>
  <div class="dropdown-content">
      <a href="js1a_form.php">J.S.S 1A</a>
    <a href="js1b_form.php">J.S.S 1B</a>
    <a href="js1c_form.php">J.S.S 1C</a>
  </div>
   </div>   
<div class="dropdown">
  <button class="dropbtn">J.S.S 2</button>
  <div class="dropdown-content">
      <a href="js2a_form.php">J.S.S 2A</a>
    <a href="js2b_form.php">J.S.S 2B</a>
    <a href="js2c_form.php">J.S.S 2C</a>
  </div>
</div> 
  <div class="dropdown">
  <button class="dropbtn">J.S.S 3</button>
  <div class="dropdown-content">
      <a href="js3a_form.php">J.S.S 3A</a>
    <a href="js3b_form.php">J.S.S 3B</a>
    <a href="js3c_form.php">J.S.S 3C</a>
  </div>
  </div>
  <div class="dropdown">
  <button class="dropbtn">S.S.S 1</button>
  <div class="dropdown-content">
      <a href="ss1a_form.php">S.S.S 1A</a>
    <a href="ss1b_form.php">S.S.S 1B</a>
    <a href="ss1c_form.php">S.S.S 1C</a>
  </div>
</div> 
  <div class="dropdown">
  <button class="dropbtn">S.S.S 2</button>
  <div class="dropdown-content">
      <a href="ss2a_form.php">S.S.S 2A</a>
    <a href="ss2b_form.php">S.S.S 2B</a>
  </div>
</div>
<div class="dropdown">
  <button class="dropbtn">S.S.S 3</button>
  <div class="dropdown-content">
      <a href="ss3a_form.php">S.S.S 3A</a>
    <a href="ss3b_form.php">S.S.S 3B</a>
