      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
              <li class="active"><a href="pri2a_time_table_fetchingdata.php">Primary 2A</a></li>
              <li><a href="#">Primary 2B</a></li>
            <li><a href="#">Primary 2C</a></li>
              <li><a href="pri2a_time_table.php">Goto Create Time Table</a></li> 
          </ul>
...
<br><br><br>
<center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOLS</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h5><h5><strong> NURSERY/PRIMARY AND SECONDARY SCHOOL,</strong></h5><h5><strong>Primary 2A Third Term Time Table</strong></h5></center>
    <br>
 ...
 $select="SELECT * FROM pri2a_time_table";
 ...
 while($fetch=mysqli_fetch_array($query)){
	 ...
	 $time8=$fetch["time8"];
         $time9=$fetch["time9"];
	 $reset='<a class="btn btn-success" style="color:black;" href="pri2a_timetable_reset.php?id='.$fetch['timeTable_id'].'">Reset</a>';
   ...
   echo "<tr>
		   ...
		   <td>$time9</td>
		   <td id='ed'>$reset</td>
		   <td id='ed'><form method='post' action='pri2a_timetable_delete.php'>
