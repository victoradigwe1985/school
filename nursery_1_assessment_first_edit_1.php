...
$id=$_GET["id"];
$select="SELECT *FROM nursery_1_assessment_first_register WHERE register_id='$id'";
...
<div class="form" style=" margin-bottom: 10%">
     ...
     <form method="POST" action="nursery_1_assessment_first_update_1.php?id=<?php echo "$user" ?>" >
