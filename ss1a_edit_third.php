...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
    ...
    <body>
        ...
        <a href="ss1a_select_session_term.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
...
$id=$_GET["id"];
$select="SELECT *FROM ss1a_schoolfee_third WHERE register_id='$id'";
...
<div class="form" style=" margin-bottom: 10%">
    <h4>Enter Amount To Update School Fee</h4>
     <form method="POST" action="ss1a_update_third.php?id=<?php echo "$user" ?>" 
