...
#scroll {
  ...
  padding: 20px;
    ...
    <body>
        ...
        <a href="nursery_1_select_term_transcript.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
        
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; margin-left:15%; padding-bottom: 10%;"  id="scroll"> 
        
    <center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOLS</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h5><h5><strong> NURSERY,PRIMARY AND SECONDARY SCHOOL,</strong></h5><h6><strong>NURSERY 1 FIRST TERM TRANSCRIPT</strong></h6></center>
    <br>
    <table class="table-striped" cellpadding="15px" width="100%" border="1px" cellspacing="0px">
        <tr align="left" >
            ...
            $select="SELECT * FROM nursery_1_first_term_scores";
    ...
    <center><div class="container" style="margin-top: 5%;"> <a href="first_term_nursery_1_transcript_1.php"><button value="OK">Extract To Print</button></a></div></center>
