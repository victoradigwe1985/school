...
$id=$_GET["id"];
$select="SELECT *FROM pre_nursery_assessment_third_register WHERE register_id='$id'";
...
<div class="form" style=" margin-bottom: 10%">
     ...
     <form method="POST" action="pre_nursery_assessment_third_update_1.php?id=<?php echo "$user" ?>" >
