...
<html>
    ...
    <body>
        ...
        <a href="pri3c_select_term.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
        <div class="container-fluid" style="background-color: lightgoldenrodyellow;"> 
          
          
            <center> 
              <div class="container" style="width:40%; margin:5% 15%; float: left;">
  <h2  style="padding-bottom:5%;">Enter Details to View Result</h2>
  <form class="form-horizontal" role="form" action="second_term_pri3c_login_handler.php" method="POST" >
