...
<html>
    ...
    <body>
        ...
        <a href="pri4c_select_term.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
  ...
  <form class="form-horizontal" role="form" action="second_term_pri4c_login_handler.php" method="POST" >
