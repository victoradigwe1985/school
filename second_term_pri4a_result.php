 <?php
           include_once("connection.php");
            ...
            $select="SELECT *FROM primary4a_second_term_scores WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
                 ...
                 $Average=$row["Average"];
                  ...
                  $select="SELECT *FROM pri4a_assessment_second_register WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:1.5em;">
        <thead>
            <tr>
                <th style="width:65%">Name of Student: <?php echo $surname;?>  <?php echo  $middle_name;?>  <?php echo  $first_name;?> </th>
            <th style="width:13%">Age: <?php echo  '9+';?></th>
            <th style="width:22%">Class: Primary 4A</th>
            </tr>
    </thead>
            </table>
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 14px; line-height:1.5em;">
            ...
            <th style="width:40%;">Admission No:  <?php echo $admission_no;?></th>
             <th style="width:31%;">Term Ends:  <?php echo  '7th April 2023';?></th>
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="">
    <thead>
            ...
            <td style="text-align: center;"><?php echo $lit_gl;?></td>
