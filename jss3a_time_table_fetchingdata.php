...
@media Print{
    ...
    <body>
         <div class="container" style="width:200px; height:1500px; position: fixed; background-color: black; margin-left: 0px; position: fixed; float: left; padding-top: 20px;" id="con">
        ...
        <a href="class_selector_view_timetable.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
...
<nav class="navbar navbar-default navbar-fixed-top" style=" margin-left:15%; ">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" id="navbar1" href="class_selector_view_timetable.php"> << Go Back</a>
        </div>
		
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
              <li class="active"><a href="jss1a_time_table_fetchingdata.php">J.S.S.3A</a></li>
              <li><a href="#">J.S.S.3B</a></li>
            <li><a href="#">J.S.S.3C</a></li>
              <li><a href="jss3a_time_table.php">Goto Create Time Table</a></li> 
          </ul>
...
<br><br><br>
<center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOLS</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h5><h5><strong> NURSERY/PRIMARY AND SECONDARY SCHOOL,</strong></h5><h5><strong>J.S.S 3A Third Term Time Table</strong></h5></center>
    <br>
 ...
 $select="SELECT * FROM jss3a_time_table";
 ...
 while($fetch=mysqli_fetch_array($query)){
	 ...
	 $time8=$fetch["time8"];
     $time9=$fetch["time9"];
	 $reset='<a class="btn btn-success" style="color:black;" href="jss3a_timetable_reset.php?id='.$fetch['timeTable_id'].'">Reset</a>';
   ...
   echo "<tr>
		   ...
		   <td>$time9</td>
		   <td id='ed'>$reset</td>
		   <td id='ed'><form method='post' action='jss3a_timetable_delete.php'>
