...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
    ...
    <body>
        ...
        <a href="class_selector_assessment.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
        <div class="container-fluid" style="background-color: lightgoldenrodyellow;"> 
            ...
            <center style="margin-top:20px;"> 
                ...
                <a style="margin-top:20px;" href="pre_nursery_assessment.php" class="btn btn-lg btn-success">First Term</a>
                <a style="margin-top:20px;" href="#" class="btn btn-lg btn-success">Second Term</a>
                <a style="margin-top:20px;" href="pre_nursery_assessment_third.php" class="btn btn-lg btn-success">Third Term</a>
            </center>
