...
$id=$_GET["id"];
$select="SELECT *FROM jss1c_schoolfee WHERE register_id='$id'";
...
if(mysqli_num_rows($query)>=1){
    ...
    ?>
             <div class="container" style="width:40%;"><br><br><br>           
<div class="form" style=" margin-bottom: 10%">
    <h4>Enter Amount To Update School Fee</h4>
     <form method="POST" action="jss1c_update.php?id=<?php echo "$user" ?>" 
