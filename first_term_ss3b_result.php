 <?php
           include_once("connection.php");
              $id=$_GET["id"];
              $select="SELECT  *FROM ss3b_register WHERE admission_no='$id'";
            ...
            $select="SELECT *FROM first_term_ss3b WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
...
<html>
    ...
    <body>
        ...
        <a href="first_term_ss3b_login.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
          ...
          <div class="container" style=" padding-left: 15%; padding-right: 8%; padding-top: 5%;" id="b">
             <table cellpadding="15px" width="100%" cellspacing="0px" style="width:100%;">
               ...
               <?php
               $query="SELECT *FROM ss3b_register WHERE admission_no='$id'";
