...
<div class="container" style="width:200px; height:1500px; position: fixed; background-color: black; margin-left: 0px; float: left; padding-top: 20px;" id="con">
        ...
        <a href="homepage_1.php" class="btn btn-md btn-success" style="border-color:gray;  font-size: 16px; color:white;  margin-top: 10px;">Goto Main Menu</a><br>
        <a href="class_selector_view_timetable_1.php" class="btn btn-md btn-success" style="border-color: gray;  font-size: 16px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
...
$id=$_GET["id"];
$query="SELECT * FROM pre_nursery_time_table WHERE timeTable_id='$id'";
...
<div class="container">
  ...
  <form method="post" action="pre_nursery_time_table_update.php?id=<?php echo "$timeTable_id" ?>">
       <div class="row">
