 ...
 */
 ...
 if(isset($_POST["submit"])){
         ...
         $select="SELECT stud_id FROM nursery_3_second_schoolfee WHERE stud_id='$stud_id'";
            if($query=mysqli_query($connect,$select)){
                $num=mysqli_num_rows($query);
                if($num > 0){
                    $msg="Student ID <b>$stud_id </b> already exists!";
                    header("location:nursery_3_new_second_term.php?msg=$msg");
                }else{
                        $insert="INSERT INTO nursery_3_second_schoolfee(stud_id,fullname,firstpay,secondpay,fullpay,total)VALUES('$stud_id','$fullname','$firstpay','$secondpay','$fullpay','$total')";
                        if(mysqli_query($connect,$insert)){
                            $msg2="School Fee Added Successfully !";
                             header("location:nursery_3_new_second_term.php?msg2=$msg2");
                        }else{
                            $msg2="failed to exercute query on the database!";
                             header("location:nursery_3_new_second_term.php?msg2=$msg2");
                        }
                }
            }
...
#submit:hover{
   ...
   color:white;
    ...
    <body>
        ...
        <a href="nursery_3_select_fee_term.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
         <a href="nursery_3_second_existing.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;">View Records</a><br>
        </div>
        
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; margin-left:30%; width: 50%; height: 70%; "> 
             <br>
        <div class="container" style="padding-left: 1%; width: 60%;">
         ...
         <form action="" method="POST" class="form-horizontal" role="form" style="background-color:lightgray; height:550px; width: 350px;" >
       <h2  style=" font-size: 25px; text-align: center; font-family: ubuntu; background-color: darkslategrey; color:white;">Add Payment</h2>
       <div class="form-group" style="padding-left:25px; width: 300px; padding-top:px; "><br><br>
      ...
      <button type="submit"  name="submit" class="btn btn-gray" id="submit">Submit</button>
          ...
          <div style="background-color:lightgray; width: 350px; padding: 5px;"> <a href="nursery_3_new_second_term.php"><button value="OK" class="btn btn-gray" id="submit">OK</button></a> <a href="nursery_3__second_existing.php"><button value="View Records" class="btn btn-gray" id="submit">View Records</button></a></div>
</div>
