...
<title>Lecture Time Table for Computer Science Department</title>
...
$id=$_GET["id"];
$query="SELECT * FROM jss1b_time_table WHERE timeTable_id='$id'";
...
<div class="container">
  ...
  <form method="post" action="jss1b_time_table_update.php?id=<?php echo "$timeTable_id" ?>">
    <div class="row">
