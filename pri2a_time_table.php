...
.label{
  ...
  <div class="container">
      <center><h3 class='text-default'>Select Subject and Create Time Table for Primary 2A</h3></center></br>
	<form role="form" action="pri2a_time_table_handller.php" method="post">
	   <div class="row">
