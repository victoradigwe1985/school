...
#scroll {
         ...
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; padding-bottom: 0%;"> 
             ...
             <div class="container" id="scroll">
                 <div class="container" style="margin-top: -5%;  width: 70%;" >
                     <form action="js1a_handller.php" method="POST" class="form-horizontal" role="form"  enctype="multipart/form-data" >
      
         <br><br><br>
         <div class="Reg_form"  style="">
     <img id="image" src='image/log.jpg' width='100' height='100' alt='logo'> 
     <center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOL</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h5><h5><strong> NURSERY/PRIMARY AND SECONDARY SCHOOL,</strong></h5></center>
     <center> <h5><strong>ONLINE REGISTRATION FORM</strong></h5></center>
    <hr>
 ...
 <p style="color:red; padding-top: 10px;">
      ...
      <div class="col-sm-10">
          <input type="text" name="firstname" class="form-control input-lg" maxlength="15" required="required" placeholder="Enter First Name">
      </div>
    </div>
         <div class="form-group">
         <label class="control-label col-sm-2" for="inputlg">Middle Name:</label>
      <div class="col-sm-10">
        <input type="text" name="middlename" class="form-control input-lg" maxlength="12" required="required" placeholder="Enter Middle Name">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="inputlg">Surname:</label>
      <div class="col-sm-10">          
          <input type="text" name="surname" class="form-control input-lg" maxlength="15"  required="required" placeholder="Enter Surname">
      </div>
    </div>
       <div class="form-group">
      ...
      <div class="col-sm-10">          
          <input type="password" name="password" maxlength="8"  class="form-control input-lg"  required="required" placeholder="Enter Password">
      </div>
    </div>
      <div class="form-group">
