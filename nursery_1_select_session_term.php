...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
    ...
    <body>
     ...
     <center>  <div class="table" style="padding-top:15%; font-size: 5em;">
           ...
           <a href="nursery_1_existing.php"> <button type="button" class="btn btn-success ">First Term</button></a>
          <a href="nursery_1_existing.php"> <button type="button" class="btn btn-success  ">Second Term</button></a>
          <a href="nursery_1_existing_third.php"> <button type="button" class="btn btn-success  ">Third Term</button></a>
