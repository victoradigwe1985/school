    ...
    <body>
        ...
        <a href="result_1.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
         ...
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; margin-left:0%; margin-bottom: 1%;"> 
             ...
             <center> <div class="container" style="padding:0px 15px;"><br><br><br><br><br><br>
                 <h3>Select Class </h3>
   <div class="dropdown">
  <button class="dropbtn">Nursery</button>
  <div class="dropdown-content">
      <a href="pre_nursery_select_term_transcript.php">Pre-Nursery</a>
    <a href="nursery_1_select_term_transcript.php">Nursery 1</a>
    <a href="nursery_2_select_term_transcript.php">Nursery 2</a>
    <a href="nursery_3_select_term_transcript.php">Nursery 3</a>
  </div>
   </div> 
   <div class="dropdown">
  <button class="dropbtn">Primary 1</button>
  <div class="dropdown-content">
      <a href="pri1a_select_term_transcript.php">Primary 1A</a>
    <a href="#">Primary 1B</a>
    <a href="#">Primary 1C</a>
  </div>
   </div>                
<div class="dropdown">
  ...
  <div class="dropdown-content">
      <a href="pri2a_select_term_transcript.php">Primary 2A</a>
    <a href="#">Primary 2B</a>
    <a href="#">Primary 2C</a>
  </div>
</div> 
  ...
  <div class="dropdown-content">
      <a href="pri3a_select_term_transcript.php">Primary 3A</a>
    <a href="#">Primary 3B</a>
    <a href="#">Primary 3C</a>
  </div>
  </div>
  ...
  <div class="dropdown-content">
      <a href="pri4a_select_term_transcript.php">Primary 4A</a>
    <a href="#">Primary 4B</a>
    <a href="#">Primary 4C</a>
  </div>
</div> 
  ...
  <div class="dropdown-content">
      <a href="pri5a_select_term_transcript.php">Primary 5A</a>
    <a href="#">Primary 5B</a>
  </div>
</div>
<div class="dropdown">
  ...
  <div class="dropdown-content">
      <a href="pri6a_select_term_transcript.php">Primary 6A</a>
    <a href="#">Primary 6B</a>
