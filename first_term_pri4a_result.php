 <?php
           include_once("connection.php");
              $id=$_GET["id"];
              $select="SELECT  *FROM pri4a_register WHERE admission_no='$id'";
            ...
            $select="SELECT *FROM primary4a_first_term_scores WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
                 ...
                 $select="SELECT *FROM pri4a_assessment_first_register WHERE admission_no='$id'";
                $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
...
<link rel="stylesheet" media="print" href="print.css" />
    ...
    <body>
        ...
        <div class="container" style=" padding-left: 15%; padding-right: 8%; padding-top: 10%;" id="b">
             <table cellpadding="15px" width="100%" cellspacing="0px" style="width:100%;">
               ...
               <?php
               $query="SELECT *FROM pri4a_register WHERE admission_no='$id'";
 ...
 <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:1.2em;">
        <thead>
            <tr>
                <th style="width:60%">Name of Student: <?php echo $surname;?> <?php echo  $first_name;?> </th>
            <th style="width:15%">Age:<?php echo  '8+';?></th>
            <th style="width:25%">Class:  <?php echo' Primary 4A';?></th>
            </tr>
    </thead>
            </table>
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 14px;">
            <tbody>
                <tr><th style=" text-align: center;">Acedemic Performance Level for Grade</th></tr>
            </tbody>
                </table>
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="" >
    <thead>
            ...
            <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="">
             ...
             <th style="text-align: center; line-height:1em;">Christian Religion Studies<br> and<br> Nation Value</th>
          ...
          <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="" >
              <thead>
             <tr style=" font-size: 13px;">
             <th style="text-align: center; line-height:1.5em;">Basic Science<br> and<br> Technology</th>
            <th style=" text-align: center;">Test<br>%</th>
            <th style=" text-align: center;">Project<br>%</th>
            <th style=" text-align: center;">Assessment<br>%</th>
            <th style=" text-align: center;">Exam<br>%</th>
           ...
           <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="">
            <thead>
             <tr style=" font-size: 13px;">
             <th style="text-align: center; line-height:1em;">Mathematics</th>
            <th style=" text-align: center;">Test<br>%</th>
            <th style=" text-align: center;">Project<br>%</th>
            <th style=" text-align: center;">Assessment<br>%</th>
            <th style=" text-align: center;">Exam<br>%</th>
            ...
            <td style="text-align: center;"><?php echo $math_sg;?></td>
              ...
              <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="">
                  <thead>
             <tr style=" font-size: 13px;">
                 <th style="text-align: center; line-height:1em; ">Pre-Vocational<br> Studies</th>
            <th style=" text-align: center;">Test<br>%</th>
            <th style=" text-align: center;">Project<br>%</th>
            <th style=" text-align: center;">Assessment<br>%</th>
            <th style=" text-align: center;">Exam<br>%</th>
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="">
    <thead>
            ...
            <td style="text-align: center;"><?php echo $lit_total;?></td>
            <td style="text-align: center;"style="text-align: center;"><?php echo $lit_gl;?></td>
            <td style="text-align: center;"><?php echo $lit_sg;?></td>
            </tr>
            <tr style="font-size: 13px; line-height: 1.2em;">
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px;" style=" font-size: 13px; line-height: 1.7em;">
                <thead>
            <tr>
            <th style=" width: 31%;">Class Teacher Comment:</th>
