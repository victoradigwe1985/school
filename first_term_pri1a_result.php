 <?php
           include_once("connection.php");
              $id=$_GET["id"];
              $select="SELECT  *FROM pri1a_register WHERE admission_no='$id'";
            ...
            $select="SELECT *FROM primary1a_first_term_scores WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
                 ...
                 $Average=$row["Average"];
                  ...
                  $select="SELECT *FROM pri1a_assessment_first_register WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
    ...
    <body>
        ...
        <div class="container" style=" padding-left: 15%; padding-right: 8%; padding-top: 10%;" id="b">
             <table cellpadding="15px" width="100%" cellspacing="0px" style="width:100%;">
               ...
               <?php
               $query="SELECT *FROM pri1a_register WHERE admission_no='$id'";
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:2em;">
       <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:1.9em;">
        <thead>
            ...
            <th style="width:15%">Age:<?php echo  '5+';?></th>
            <th style="width:25%">Class:  <?php echo' Primary 1A';?></th>
            </tr>
    </thead>
            </table>
