...
.label{
  ...
  <div class="container">
      <center> <h3 class='text-default'>Select Subject and Create Time Table for Nursery 2</h3></center></br>
	<form role="form" action="nursery_2_time_table_handller.php" method="post">
	   <div class="row">
