...
.label{
  ...
  <div class="container">
      <center><h3 class='text-default'>Select Subject and Create Time Table for J.S.S 2A</h3></center></br>
	<form role="form" action="jss2a_time_table_handller.php" method="post">
	 <div class="row">
	    ...
	    <div class="form-group">
		 <label class="label">Time:8:00am-8:45am</label>
	       <select name="select2" class="form-control" placeholder="">
			   ...
			   <option>Igbo Lang.</option>
			   <option>English Lang.</option>
			   <option>Mathematics</option>
			   <option>Integrated Sci.</option>
			   <option>Fine & Applied Art</option>
			   <option>Agricultural Sci.</option>
			   <option>Civic Edu.</option>
			   <option>P.H.E</option>
			   <option>Account</option>
			   <option>Government</option>
			   <option>Lit. in Eng.</option>
                           <option>Computer Study</option>
                           <option>Marketing</option>
                           <option>Home Econs.</option>
			</select>
         </div>
		</div>
	 ...
	 <div class="col-md-2">
	  ...
	  <div class="col-md-2">
	    <div class="form-group">
		 <label class="label">Time:10:00am-11:00am</label>
