      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
              <li><a href="jss3a_time_table_fetchingdata.php">J.S.S.3A</a></li>
               <li class="active"><a href="jss3b_time_table_fetchingdata.php">J.S.S.3B</a></li>
               <li><a href="jss3c_time_table_fetchingdata.php">J.S.S.3C</a></li>
              <li><a href="jss3b_time_table.php">Goto Create Time Table</a></li> 
...
<center> <h4><strong>BRAIN TRUST SECONCARY SCHOOL,</strong></h4><h5><strong>J.S.S 3B First Term Time Table</strong></h5></center>
 ...
 while($fetch=mysqli_fetch_array($query)){
	 ...
	 $time8=$fetch["time8"];
     $time9=$fetch["time9"];
	 $reset='<a class="btn btn-success" style="color:black;" href="jss3b_timetable_reset.php?id='.$fetch['timeTable_id'].'">Reset</a>';
   ...
   echo "<tr>
		   ...
		   <td>$time9</td>
		   <td>$reset</td>
		   <td><form method='post' action='jss3b_timetable_delete.php'>
...
<div class="container"> <a href="jss3b_time_table_fetchingdata1.php"><button value="OK">Extract To Print</button></a></div>
 </div> 
    </div>
    </body>
</html>