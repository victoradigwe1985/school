         ...
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; padding-bottom: 0%;"> 
             ...
             <div class="container" id="scroll">
                 <div class="container" style="margin-top: -5%;  width: 70%;" >
                     <form action="pre_nursery_handller.php" method="POST" class="form-horizontal" role="form"  enctype="multipart/form-data" >
          ...
          <select name="class" required="required" class="form-control input-lg">
            ...
            <option>Primary 1A</option>
             <option>Primary 1B</option>
              <option>Primary 1C</option>
              <option>Primary 2A</option>
             <option>Primary 2B</option>
              <option>Primary 2C</option>
              <option>Primary 3A</option>
             <option>Primary 3B</option>
              <option>Primary 3C</option>
              <option>Primary 4A</option>
             <option>Primary 4B</option>
              <option>Primary 4C</option>
              <option>Primary 5A</option>
             <option>Primary 5B</option>
             <option>Primary 6A</option>
             <option>Primary 6B</option>
