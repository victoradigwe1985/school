...
#scroll {
  ...
  padding: 20px;
    ...
    <center> <h4><strong>BRAIN TRUST SECONCARY SCHOOL,</strong></h4><h5><strong>J.S.S 1B FIRST TERM TRANSCRIPT</strong></h5></center>
    <br>
        <table cellpadding="15px" width="100%" border="1px" cellspacing="0px">
            ...
            $select="SELECT * FROM first_term_jss1b";
    ...
    <center><div class="container" style="margin-top: 5%;"> <a href="first_term_jss1b_transcript_1.php"><button value="OK">Extract To Print</button></a></div></center>
