...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
    ...
    <body>
        ...
        <a href="class_selector_assessment.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;">Assessment Sheet</a><br>
        ...
        <div class="container-fluid" style="background-color: lightgoldenrodyellow;"> 
            <div class="table" style="padding:15%; font-size: 30px; margin-left: 10%;">
          
            <center> 
                <div style="float: left; padding: 20px;"><a href="class_selector_result_1.php" class="btn btn-lg btn-success">Click To View Result</a></div>
                <div style=" padding: 20px;"><a href="class_selector_transcript_1.php" class="btn btn-lg btn-success">Click To View Transcript</a></div>
            </center>
