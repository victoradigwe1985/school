...
#scroll {
  ...
  padding: 5px;
    ...
    <body>
     ...
     <center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOL</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h5><h5><strong> NURSERY/PRIMARY AND SECONDARY SCHOOL,</strong></h5><h6><strong>Primary 3A Assessment Records</strong></h6></center>
    <br>
    <table class="table  table-bordered table-condensed  table-striped">
            ...
            $select="SELECT * FROM pri3a_assessment_register";
            $query=mysqli_query($connect,$select);
                ...
                $edit ='<a href="pri3a_assessment_edit_1.php?id='.$row['register_id'].'"><button  type="button " value="Edit">Add</button></a>';
