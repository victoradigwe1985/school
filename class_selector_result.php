    ...
    <body>
        ...
        <a href="result.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
         ...
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; margin-left:0%;"> 
             ...
             <center> <div class="container" style="padding:0px 5px;"><br><br><br>
                
                 <div style="margin-left:15%;">
                      <h2 style="background-color:green; color:white; width: 25%; height: 200px; font-family: ubuntu; margin-bottom: 5%;">Select Class To Check Result</h2>
  <div class="dropdown">
  <button class="dropbtn">J.S.S 1</button>
  <div class="dropdown-content">
      <a href="js1a_select_term.php">J.S.S 1A</a>
    <a href="js1b_select_term.php">J.S.S 1B</a>
    <a href="js1c_select_term.php">J.S.S 1C</a>
  </div>
   </div>   
<div class="dropdown">
  <button class="dropbtn">J.S.S 2</button>
  <div class="dropdown-content">
      <a href="js2a_select_term.php">J.S.S 2A</a>
    <a href="js2b_select_term.php">J.S.S 2B</a>
    <a href="js2c_select_term.php">J.S.S 2C</a>
  </div>
</div> 
  <div class="dropdown">
  <button class="dropbtn">J.S.S 3</button>
  <div class="dropdown-content">
      <a href="js3a_select_term.php">J.S.S 3A</a>
    <a href="js3b_select_term.php">J.S.S 3B</a>
    <a href="js3c_select_term.php">J.S.S 3C</a>
  </div>
  </div>
  <div class="dropdown">
  <button class="dropbtn">S.S.S 1</button>
  <div class="dropdown-content">
      <a href="ss1a_select_term.php">S.S.S 1A</a>
    <a href="ss1b_select_term.php">S.S.S 1B</a>
    <a href="ss1c_select_term.php">S.S.S 1C</a>
  </div>
</div> 
  <div class="dropdown">
  <button class="dropbtn">S.S.S 2</button>
  <div class="dropdown-content">
      <a href="ss2a_select_term.php">S.S.S 2A</a>
    <a href="ss2b_select_term.php">S.S.S 2B</a>
  </div>
</div>
<div class="dropdown">
  <button class="dropbtn">S.S.S 3</button>
  <div class="dropdown-content">
      <a href="ss3a_select_term.php">S.S.S 3A</a>
    <a href="ss3b_select_term.php">S.S.S 3B</a>
