 <?php
           include_once("connection.php");
              $id=$_GET["id"];
              $select="SELECT  *FROM pre_nursery_register WHERE admission_no='$id'";
            ...
            $select="SELECT *FROM pre_nursery_second_term_scores WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
                 ...
                 $rhyme_test=$row["rhyme_test"];  
                 $rhyme_project=$row["rhyme_project"];
                 $rhyme_assessment=$row["rhyme_assessment"];
                 $rhyme_exam=$row["rhyme_exam"];
                 $rhyme_total=$row["rhyme_total"];
                 $rhyme_gl=$row["rhyme_gl"];
                 $rhyme_sg=$row["rhyme_sg"];
                 
                 $handwriting_test=$row["handwriting_test"];  
                 $handwriting_project=$row["handwriting_project"];
                 $handwriting_assessment=$row["handwriting_assessment"];
                 $handwriting_exam=$row["handwriting_exam"];
                 $handwriting_total=$row["handwriting_total"];
                 $handwriting_gl=$row["handwriting_gl"];
                 $handwriting_sg=$row["handwriting_sg"];
                 ...
                 $Average=$row["Average"];
                  ...
                  $select="SELECT *FROM pre_nursery_assessment_second_register WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
...
<link rel="stylesheet" media="print" href="print.css" />
    ...
    <body>
        ...
        <a href="second_term_pre_nursery_login.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
        ...
        <div class="container" style=" padding-left: 15%; padding-right: 8%; padding-top: 10%;" id="b">
             <table cellpadding="15px" width="100%" cellspacing="0px" style="width:100%;">
               ...
               <?php
               $query="SELECT *FROM pre_nursery_register WHERE admission_no='$id'";
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:1.9em;">
        <thead>
            ...
            <th style="width:15%">Age:<?php echo  '1+';?></th>
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 14px; line-height:1.9em;">
           ...
           <th style="width:31%;">Term Ends:  <?php echo  '7th Apri 2023';?></th>
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:1.9em;">
                <thead>
            <tr>
            <th style="">Total Mark Obtainable: 1200</th>
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="" >
    <thead>
            ...
            <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="">
                <thead>
             <tr style=" font-size: 13px;">
             <th style="text-align: center; line-height:1.4em;">Language <br> and<br> Communication Skills</th>
            ...
            <tr style="font-size: 13px; line-height: 1.4em;">
          ...
          <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="" >
              <thead>
             <tr style=" font-size: 13px;">
             <th style="text-align: center; line-height:1.4em;">Mathematics<br>Skills</th>
            <th style=" text-align: center;">Test<br>%</th>
            <th style=" text-align: center;">Project<br>%</th>
            <th style=" text-align: center;">Assessment<br>%</th>
            <th style=" text-align: center;">Exam<br>%</th>
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="">
    <thead>
             <tr style=" font-size: 13px;">
             <th style="text-align: center; line-height:1.4em;"></th>
            <th style=" text-align: center;">Test<br>%</th>
            <th style=" text-align: center;">Project<br>%</th>
            <th style=" text-align: center;">Assessment<br>%</th>
            <th style=" text-align: center;">Exam<br>%</th>
            ...
            <tr style="font-size: 13px; line-height: 1.4em;">
            <td>Rhyme</td>
            <td style="text-align: center;"><?php echo $rhyme_test;?></td>
            <td style="text-align: center;"><?php echo $rhyme_project;?></td>
            <td style="text-align: center;"><?php echo $rhyme_assessment;?></td>
            <td style="text-align: center;"><?php echo $rhyme_exam;?></td>
            <td style="text-align: center;"><?php echo $rhyme_total;?></td>
            <td style="text-align: center;"><?php echo $rhyme_gl;?></td>
            <td style="text-align: center;"><?php echo $rhyme_sg;?></td>
            </tr>
            <tr style="font-size: 13px; line-height: 1.4em;">
            <td>Hand Writing</td>
            <td style="text-align: center;"><?php echo $handwriting_test;?></td>
            <td style="text-align: center;"><?php echo $handwriting_project;?></td>
            <td style="text-align: center;"><?php echo $handwriting_assessment;?></td>
            <td style="text-align: center;"><?php echo $handwriting_exam;?></td>
            <td style="text-align: center;"><?php echo $handwriting_total;?></td>
            <td style="text-align: center;"><?php echo $handwriting_gl;?></td>
            <td style="text-align: center;"><?php echo $handwriting_sg;?></td>
            </tr>
           </table>
...
<table cellpadding="15px" width="50%" border="1px" cellspacing="0px" style="float:left; margin-top: 3px;">
            ...
            <tr style="font-size: 11px; line-height: 1.3em;">
