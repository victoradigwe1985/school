 <?php
           include_once("connection.php");
            ...
            $select="SELECT *FROM second_term_ss1a WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
                 ...
                 $Average=$row["Average"];
                 $form_master_remark=$row["Form Master Remark"];
                 $house_master_remark=$row["House Master Remark"];
...
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:2em;">
            ...
            <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:2em;">
                <thead>
            <tr>
            <th style="">Total Mark Obtainable: 1000</th>
            ...
            <tr>
                ...
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $igb_total;?></td>
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $igb_grade;?></td>
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $igb_subject_position;?></td>
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $igb_teach_remarks;?></td>
            </tr>
            <tr>
