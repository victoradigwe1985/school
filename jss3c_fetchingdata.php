...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
 ...
 @media Print{
    ...
    <center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOL</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h4><h5><strong> NURSERY/PRIMARY AND SECONDARY SCHOOL,</strong></h5><h5><strong>J.S.S 3C RECORDS</strong></h5></center>
    <br>
    <table id="mg" class="table  table-bordered table-condensed  table-striped" style="margin-left:10%;">
            ...
            $select="SELECT * FROM js3c_register";
            $query=mysqli_query($connect,$select);
                ...
                $edit ='<a href="jss3c_edit_1.php?id='.$row['register_id'].'"><button  type="button " value="Edit">Edit</button></a>';
                $view ='<a href="jss3c_view.php?id='.$row['register_id'].'"><button  type="button " value="View">View</button> </a>';
                echo "<tr><td>$register_id</td>
                        ...
                        <td>$registered_on</td>
                         ...
                         <td id='ed'>   <form method='POST' action='jss3c_delete_1.php'>
