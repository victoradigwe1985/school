...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
 ...
 @media Print{
    ...
    <body>
        ...
        <a href="jss1b_select_session_term.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
      
         <div class="container-fluid" style="background-color: lightgoldenrodyellow; margin-left:15%; padding-bottom: 10%;" id="scroll"> 
         
             <center> <h4><strong>SALVATION EXCELLENCE GROUP OF SCHOOLS</strong></h4><h5><strong> No 7 Dein Street, Agbor Delta State </strong></h5><h5><strong> NURSERY/PRIMARY AND SECONDARY SCHOOL,</strong></h5></strong></h4><h5><strong>J.S.S 1B First Term School Fee Record</strong></h5></center>
    <br>
    <center> <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size:16px;" >
            ...
            $select="SELECT * FROM jss1b_schoolfee";
            $query=mysqli_query($connect,$select);
              ...
              $total1 += $total;
               ...
               $edit ='<a href="jss1b_edit.php?id='.$row['register_id'].'"><button  type="button " value="Edit">Add</button></a>';
                echo "<tr><td>$register_id</td>
                         ...
                         <td>$fullpay</td>
                         <td>$total</td>
                              <td id='ed'>   <form method='POST' action='jss1b_delete.php'>
