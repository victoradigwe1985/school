...
<div class="container" style="width:200px; height:15000px; background-color: black; margin-left: 0px; float: left; padding-top: 20px;" id="con">
...
$id=$_GET["id"];
$query="SELECT * FROM pri1a_time_table WHERE timeTable_id='$id'";
...
<div class="container">
  ...
  <form method="post" action="pri1a_time_table_update.php?id=<?php echo "$timeTable_id" ?>">
       <div class="row">
