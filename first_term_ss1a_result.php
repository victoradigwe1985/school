 <?php
           include_once("connection.php");
              $id=$_GET["id"];
              $select="SELECT  *FROM ss1a_register WHERE admission_no='$id'";
            ...
            $select="SELECT *FROM first_term_ss1a WHERE admission_no='$id'";
            $query=mysqli_query($connect,$select);
                while($row=mysqli_fetch_array($query)){
                 ...
                 $civic_1CA=  $row["civic_1CA"];  
                 $civic_2CA=  $row["civic_2CA"];
                 $civic_exam=$row["civic_exam"];
                 $civic_total=$row["civic_total"];
                 $civic_grade=$row["civic_grade"];
                 $civic_subject_position=$row["civic_subject_position"];
                 $civic_teach_remarks=$row["civic_teach_remarks"];
...
<html>
    ...
    <body>
        ...
        <a href="first_term_ss1a_login.php" class="btn btn-lg btn-success" style="border-color: gray;  font-size: 18px;  margin-top: 10px; color:white;"> <<< Go Back</a><br>
        </div>
          ...
          <div class="container" style=" padding-left: 15%; padding-right: 8%; padding-top: 5%;" id="b">
             <table cellpadding="15px" width="100%" cellspacing="0px" style="width:100%;">
               ...
               <?php
               $query="SELECT *FROM ss1a_register WHERE admission_no='$id'";
    ...
    $(document).ready(function(){
      ...
      <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:1.9em; margin-top: 5px;">
        <thead>
            <tr>
                <th style="width:60%">Name of Student: <?php echo $surname;?>  <?php echo  $middle_name;?>  <?php echo  $first_name;?> </th>
            <th style="width:15%">Age: <?php echo  '13+'?></th>
            <th style="width:25%">Class:  <?php echo 'S.S.S 1A';?></th>
            </tr>
    </thead>
            </table>
<table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:1.9em;">
            ...
            <table cellpadding="15px" width="100%" border="1px" cellspacing="0px" style="font-size: 15px; line-height:1.9em;">
                <thead>
            <tr>
            <th style="">Total Mark Obtainable: 900</th>
            ...
            <tr>
                <td style="line-height:1.5em; padding-left: 15px;">Civic Education</td>
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $civic_1CA;?></td>
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $civic_2CA;?></td>
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $civic_exam;?></td>  
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $civic_total;?></td>
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $civic_grade;?></td>
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $civic_subject_position;?></td>
                <td style="line-height:1.5em; padding-left: 15px;"><?php echo $civic_teach_remarks;?></td>
            </tr>
            <tr>
